// !========= Async =======
/*
Async is a keyword we to use just before the functions.
To convert the sync function into async function we have to use it 

Sync --> executes.simultaneously --> It will return the actual data
 
Async --> executes simultaneously --> It will return the data
          as a promise.

Async function will always return a promise 
normal data --> wrap into a promise --> result  a promise
promise data --> wrap into a promise --> result into a promise
*/
...
// ? ======== async function return promise data as promise ====
...
//!====== Await ====
/* In promise way , we have to use then catch finally
